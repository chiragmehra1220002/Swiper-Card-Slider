  ...
  data.innerHTML = ` <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 d-flex justify-content-end">
            <div
              class="button-prev d-flex justify-content-center align-items-center text-center"
            >
              <svg
